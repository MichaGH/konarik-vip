...
export default function AboutSection() {
	...
	return (
		<section
			ref={sectionRef}
			className="relative flex min-h-screen items-center overflow-hidden bg-[#050505] py-20 text-zinc-100 md:py-24"
		>
			...
			<div className="relative z-10 mx-auto w-full max-w-7xl px-6 md:px-10 lg:px-16">
				<div className="grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-8">
					<div ref={imageWrapRef} className="relative mx-auto w-full max-w-md lg:mx-0 lg:max-w-none">
					...
					<div className="relative text-center lg:-ml-12 lg:text-left">
						<div className="mx-auto max-w-lg lg:mx-0">
							...
							<div
								ref={textRef}
								className="mt-7 flex flex-col items-center gap-5 lg:flex-row lg:items-start"
							>
								<div
									ref={lineRef}
									className="h-px w-20 shrink-0 bg-white/10 lg:mt-1 lg:h-20 lg:w-px"
								/>
							...
							<div className="mt-10 grid grid-cols-3 gap-6 border-t border-white/10 pt-6 text-center lg:text-left">
